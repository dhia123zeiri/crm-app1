...
export default function EmailTemplatesPage() {
  ...
  const handleDelete = async (templateId: number) => {
    if (confirm('Êtes-vous sûr de vouloir supprimer ce template ?')) {
      try {
        console.log('Supprimer template:', templateId);
          ...
          <div className="flex items-center justify-between h-16">
            <div className="flex items-center space-x-4">
              ...
              <div className="flex items-center space-x-3">
                ...
                <div>
                  <h1 className="text-xl font-bold text-gray-900">Templates d'Emails</h1>
                  <p className="text-sm text-gray-500">Gérez vos modèles d'emails</p>
                </div>
              </div>
            </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          ...
          <div className="bg-white rounded-xl shadow-lg p-6 border border-gray-100">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-2xl font-bold text-orange-600">{stats.byType.reminder}</p>
              </div>
          ...
          <div className="bg-white rounded-xl shadow-lg p-6 border border-gray-100">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-2xl font-bold text-blue-600">{stats.byType.invoice}</p>
              </div>
          ...
          <div className="bg-white rounded-xl shadow-lg p-6 border border-gray-100">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-2xl font-bold text-purple-600">{stats.byType.info}</p>
              </div>
          ...
          <div className="bg-white rounded-xl shadow-lg p-6 border border-gray-100">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-2xl font-bold text-gray-600">{stats.byType.custom}</p>
              </div>
            ...
            <div key={template.id} className="bg-white rounded-xl shadow-lg border border-gray-100 overflow-hidden hover:shadow-xl transition-shadow">
                ...
                <div className="flex items-start justify-between mb-3">
                  <div className="flex-1">
                    ...
                    <div className="flex items-center space-x-2">
                      <div className={`w-2 h-2 rounded-full ${template.actif ? 'bg-green-400' : 'bg-red-400'}`}></div>
              ...
              <div className="p-6 border-b border-gray-200">
                ...
                {template.variables.length > 0 && (
                  <div>
                    <div className="font-medium text-gray-700 mb-2 text-sm">Variables :</div>
                    <div className="flex flex-wrap gap-1">
                      {template.variables.map((variable) => (
                        <span key={variable} className="inline-flex items-center px-2 py-1 rounded text-xs bg-blue-50 text-blue-700 border border-blue-200">
                          {`{${variable}}`}
                        </span>
                      ))}
                    </div>
        ...
        {filteredTemplates.length === 0 && (
          <div className="text-center py-12">
            ...
            <h3 className="text-sm font-medium text-gray-900 mb-2">Aucun template trouvé</h3>
